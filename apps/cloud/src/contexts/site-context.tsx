...
interface SiteContextValue {
  ...
  addSite: (
    site: Omit<Site, "id" | "defaultZoneId" | "devicesCount" | "zonesCount">,
  ) => Site;
...
function generateMockData() {
  ...
  const zones: Zone[] = [
    ...
    // Floors within building
    {
      ...
      parentId: "zone-1-building",
      type: "floor",
      description: "Ground floor - Reception",
      color: "#22c55e",
    },
    {
      id: "zone-1-floor2",
    ...
    {
      id: "zone-6-eng-open",
      name: "Engineering Open Plan",
      siteId: "site-6",
      parentId: "zone-6-floor10",
      type: "area",
      capacity: 50,
      color: "#3b82f6",
    },
  ...
  const devices: Device[] = [
    ...
    },
    {
      ...
      type: "access-reader",
      siteId: "site-1",
      zoneId: "zone-1-reception",
      status: "online",
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:02",
      serialNumber: "ZEZ-AR-001",
    ...
    },
    {
      ...
      type: "gateway",
      siteId: "site-1",
      zoneId: "zone-1-floor2",
      status: "online",
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:03",
      serialNumber: "ZEZ-GW-001",
    ...
    },
    {
      ...
      type: "digital-lock",
      siteId: "site-1",
      zoneId: "zone-1-server",
      status: "online",
      batteryLevel: 92,
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:04",
      serialNumber: "ZEZ-DL-002",
      firmwareVersion: "2.4.1",
    },
    {
      id: "dev-5",
      ...
      type: "camera",
      siteId: "site-1",
      zoneId: "zone-1-parking",
      status: "online",
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:05",
      serialNumber: "ZEZ-CAM-001",
    ...
    },
    {
      ...
      serialNumber: "ZEZ-SN-001",
      firmwareVersion: "1.0.5",
    },
    {
      id: "dev-7",
      name: "New Lock (Unplaced)",
      type: "digital-lock",
      siteId: "site-1",
      zoneId: null,
      status: "offline",
    ...
    },
    {
      ...
      type: "digital-lock",
      siteId: "site-1",
      zoneId: "zone-1-boardroom",
      status: "online",
      batteryLevel: 95,
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:15",
      serialNumber: "ZEZ-DL-007",
      firmwareVersion: "2.4.1",
    },
    {
      id: "dev-16",
      ...
      type: "camera",
      siteId: "site-1",
      zoneId: "zone-1-security",
      status: "online",
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:16",
      serialNumber: "ZEZ-CAM-002",
      firmwareVersion: "1.2.0",
    },
    ...
    // New York HQ devices
    {
      ...
      serialNumber: "ZEZ-AR-002",
      firmwareVersion: "1.8.3",
    },
    {
      id: "dev-9",
      name: "Lobby Turnstile 2",
      type: "access-reader",
      siteId: "site-6",
      zoneId: "zone-6-lobby",
      status: "online",
    ...
    },
    {
      ...
      type: "digital-lock",
      siteId: "site-6",
      zoneId: "zone-6-eng-open",
      status: "online",
      batteryLevel: 78,
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:10",
      serialNumber: "ZEZ-DL-004",
      firmwareVersion: "2.4.1",
    },
    {
      id: "dev-11",
      name: "Rooftop Access Lock",
      type: "digital-lock",
      siteId: "site-6",
      zoneId: "zone-6-rooftop",
      status: "offline",
      batteryLevel: 12,
      lastSeen: new Date(Date.now() - 1000 * 60 * 60 * 24),
      macAddress: "AA:BB:CC:DD:EE:11",
      serialNumber: "ZEZ-DL-005",
    ...
    // Melbourne devices
    {
      ...
      type: "access-reader",
      siteId: "site-2",
      zoneId: "zone-2-default",
      status: "online",
      lastSeen: new Date(),
      macAddress: "AA:BB:CC:DD:EE:13",
      serialNumber: "ZEZ-AR-004",
      firmwareVersion: "1.8.3",
    },
    {
      id: "dev-14",
      name: "Loading Dock Lock",
      type: "digital-lock",
      siteId: "site-2",
      zoneId: "zone-2-default",
      status: "online",
...
export function SiteProvider({ children }: { children: ReactNode }) {
  ...
  const addSite = useCallback(
    (
      siteData: Omit<
        Site,
        "id" | "defaultZoneId" | "devicesCount" | "zonesCount"
      >,
    ) => {
  ...
  const getRootZones = useCallback(
    (siteId: string) =>
      zones.filter((z) => z.siteId === siteId && z.parentId === null),
    [zones],
  );
  ...
  const getValidChildTypes = useCallback(
    (parentId: string | null, _siteId: string): ZoneType[] => {
      if (!parentId) {
  ...
  const addDevice = useCallback(
    (deviceData: Omit<Device, "id">) => {
      const _site = sites.find((s) => s.id === deviceData.siteId);
  ...
  const assignDeviceToZone = useCallback(
  ...
  const getMetricsForSite = useCallback(
    (siteId: string | null) => {
      ...
      return {
        ...
        onlineDevices: filteredDevices.filter((d) => d.status === "online")
          .length,
        offlineDevices: filteredDevices.filter((d) => d.status === "offline")
          .length,
